...
?>
    ...
    <div class="header <?php if( get_theme_mod( 'vw_restaurant_lite_sticky_header') != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
      <div class="container">
        <div class="row">
          ...
          <div class="menubox col-md-7 col-2">
          ...
          <div class="social-media col-md-3 col-4 wow bounceInDown">
  ...
  <?php if(get_theme_mod('vw_restaurant_lite_loader_enable',true)==1){ ?>
    <div class="spinner-wrapper">
      <div class="spinner">
        <?php $theme_lay = get_theme_mod( 'vw_restaurant_lite_loader_icon','Two Way');
