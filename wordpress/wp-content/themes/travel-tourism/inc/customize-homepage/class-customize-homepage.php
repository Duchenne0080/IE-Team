...
if ( ! class_exists( 'Travel_Tourism_Content_Creation' ) ) :

	/**
	 * Travel_Tourism_Content_Creation class.
	 */
	class Travel_Tourism_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * Travel_Tourism_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Travel_Tourism_Content_Creation' );
