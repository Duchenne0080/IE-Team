...
class Travel_Tourism_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder','travel-tourism' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $travel_tourism_font_awesome_icon_array = travel_tourism_font_awesome_icon_array();
                foreach ($travel_tourism_font_awesome_icon_array as $travel_tourism_font_awesome_icon) {
                        $icon_class = $this->value() == $travel_tourism_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($travel_tourism_font_awesome_icon).'"></i>
                        <span class="travel-tourism-social-class">'.esc_attr($travel_tourism_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function travel_tourism_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'travel-tourism-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'travel_tourism_customizer_script' );

if(!function_exists('travel_tourism_font_awesome_icon_array')){
    function travel_tourism_font_awesome_icon_array(){
