...
class Travel_Tourism_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Travel_Tourism_About_Widget',
			__('VW About us', 'travel-tourism'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'travel-tourism' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','travel-tourism'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','travel-tourism'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','travel-tourism'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','travel-tourism'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','travel-tourism'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','travel-tourism'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function travel_tourism_about_custom_load_widget() {
	register_widget( 'Travel_Tourism_About_Widget' );
}
add_action( 'widgets_init', 'travel_tourism_about_custom_load_widget' );