 ...
 * Field overrides.
 */
class Business_Class_Customizer_Field_FontAwesome extends Business_Class_Customizer_Field_Select {
	...
	protected function set_choices() {
		ob_start();
		$json_path = wp_normalize_path( Business_Class_Customizer::$path . '/assets/vendor/fontawesome/fontawesome.json' );
