 ...
 * Field overrides.
 */
class Business_Class_Customizer_Field_Image extends Business_Class_Customizer_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'business-class' ),
				'change'       => esc_html__( 'Change image', 'business-class' ),
				'default'      => esc_html__( 'Default', 'business-class' ),
				'remove'       => esc_html__( 'Remove', 'business-class' ),
				'placeholder'  => esc_html__( 'No image selected', 'business-class' ),
				'frame_title'  => esc_html__( 'Select image', 'business-class' ),
				'frame_button' => esc_html__( 'Choose image', 'business-class' ),
			)
		);
	}
