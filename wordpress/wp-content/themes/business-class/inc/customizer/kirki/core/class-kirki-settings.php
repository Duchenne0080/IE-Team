 ...
 */
class Business_Class_Customizer_Settings {
	...
	/**
	 * Creates a new Business_Class_Customizer_Settings object.
	 * Class constructor.
	 *
	 * @access public
	 * @param array $args The field definition as sanitized in Business_Class_Customizer_Field.
	 */
	...
	final private function set_setting_types() {
		...
		$this->setting_types = apply_filters(
			...
			array(
				...
				'repeater'    => 'Business_Class_Customizer_Settings_Repeater_Setting',
				'user_meta'   => 'Business_Class_Customizer_Setting_User_Meta',
				'site_option' => 'Business_Class_Customizer_Setting_Site_Option',
			)
		);
