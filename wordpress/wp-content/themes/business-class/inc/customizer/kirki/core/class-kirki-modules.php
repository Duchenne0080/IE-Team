...
/**
 * The Business_Class_Customizer_Modules class.
 */
class Business_Class_Customizer_Modules {
	...
	public function setup_default_modules() {
		self::$modules = apply_filters(
			'kirki_modules',
			array(
				'css'                => 'Business_Class_Customizer_Modules_CSS',
				'css-vars'           => 'Business_Class_Customizer_Modules_CSS_Vars',
				'customizer-styling' => 'Business_Class_Customizer_Modules_Customizer_Styling',
				'icons'              => 'Business_Class_Customizer_Modules_Icons',
				'loading'            => 'Business_Class_Customizer_Modules_Loading',
				'tooltips'           => 'Business_Class_Customizer_Modules_Tooltips',
				'branding'           => 'Business_Class_Customizer_Modules_Customizer_Branding',
				'postMessage'        => 'Business_Class_Customizer_Modules_PostMessage',
				'selective-refresh'  => 'Business_Class_Customizer_Modules_Selective_Refresh',
				'field-dependencies' => 'Business_Class_Customizer_Modules_Field_Dependencies',
				'custom-sections'    => 'Business_Class_Customizer_Modules_Custom_Sections',
				'webfonts'           => 'Business_Class_Customizer_Modules_Webfonts',
				'webfont-loader'     => 'Business_Class_Customizer_Modules_Webfont_Loader',
				'preset'             => 'Business_Class_Customizer_Modules_Preset',
				'gutenberg'          => 'Business_Class_Customizer_Modules_Gutenberg',
				'telemetry'          => 'Business_Class_Customizer_Modules_Telemetry',
			)
		);
	}
