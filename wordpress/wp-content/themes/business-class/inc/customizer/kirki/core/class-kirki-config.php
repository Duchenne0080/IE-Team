...
/**
 * The Business_Class_Customizer_Config object
 */
final class Business_Class_Customizer_Config {
	 ...
	 *
	 * @access private
	 * @param string $config_id @see Business_Class_Customizer_Config::get_instance().
	 * @param array  $args      @see Business_Class_Customizer_Config::get_instance().
	 */
	 ...
	 * }
	 *
	 * @return Business_Class_Customizer_Config
	 */
