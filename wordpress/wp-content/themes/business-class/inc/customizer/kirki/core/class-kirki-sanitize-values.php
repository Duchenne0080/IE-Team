 ...
 */
class Business_Class_Customizer_Sanitize_Values {
	 ...
	 *
	 * Deprecated. Use Business_Class_Customizer_Field_Checkbox::sanitize() instead.
	 *
	 * @static
	 * @access public
	 * @see Business_Class_Customizer_Field_Checkbox::sanitize()
	 * @param bool|string $value Whether the checkbox is checked.
	 * @return bool Whether the checkbox is checked.
	 */
	public static function checkbox( $value ) {
		$obj = new Business_Class_Customizer_Field_Checkbox();
