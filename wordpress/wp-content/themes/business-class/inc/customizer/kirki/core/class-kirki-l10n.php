 ...
 */
class Business_Class_Customizer_L10n {
	...
	public function load_textdomain() {
		...
		load_plugin_textdomain( $this->textdomain, false, Business_Class_Customizer::$path . '/languages' );
	}
	...
	protected function get_paths() {
		return array(
			...
			Business_Class_Customizer::$path . '/languages/' . $this->textdomain . '-' . get_locale() . '.mo',
		);
	}
