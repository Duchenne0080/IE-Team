 ...
 */
class Business_Class_Customizer_Modules_Custom_Sections {
	...
	public function set_section_types( $section_types ) {
		$new_types = array(
			'kirki-default'  => 'Business_Class_Customizer_Sections_Default_Section',
			'kirki-expanded' => 'Business_Class_Customizer_Sections_Expanded_Section',
			'kirki-nested'   => 'Business_Class_Customizer_Sections_Nested_Section',
			'kirki-link'     => 'Business_Class_Customizer_Sections_Link_Section',
		);
	...
	public function set_panel_types( $panel_types ) {
		$new_types = array(
			'kirki-nested' => 'Business_Class_Customizer_Panels_Nested_Panel',
		);
	...
	public function enqueue_scrips() {
		wp_enqueue_style( 'kirki-custom-sections', trailingslashit( Business_Class_Customizer::$url ) . 'modules/custom-sections/sections.css', array(), BUSINESS_CLASS_CUSTOMIZER_VERSION );
		wp_enqueue_script( 'kirki-custom-sections', trailingslashit( Business_Class_Customizer::$url ) . 'modules/custom-sections/sections.js', array( 'jquery', 'customize-base', 'customize-controls' ), BUSINESS_CLASS_CUSTOMIZER_VERSION, false );
	}
}
