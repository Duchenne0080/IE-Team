 ...
 */
class Business_Class_Customizer_Modules_Webfont_Loader {
	...
	public function enqueue_scripts() {
		...
		if ( self::$load || $wp_customize || is_customize_preview() ) {
			wp_enqueue_script( 'webfont-loader', trailingslashit( Business_Class_Customizer::$url ) . 'modules/webfont-loader/vendor-typekit/webfontloader.js', array(), '3.0.28', true );
		}
	}
