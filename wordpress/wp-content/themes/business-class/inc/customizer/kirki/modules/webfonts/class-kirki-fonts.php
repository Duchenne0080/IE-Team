...
/**
 * The Business_Class_Customizer_Fonts object.
 */
final class Business_Class_Customizer_Fonts {
	 ...
	 *
	 * @return object Business_Class_Customizer_Fonts
	 */
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'business-class' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'business-class' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'business-class' ),
			'200'       => esc_html__( 'Light 200', 'business-class' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'business-class' ),
			'300'       => esc_html__( 'Book 300', 'business-class' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'business-class' ),
			'400'       => esc_html__( 'Normal 400', 'business-class' ),
			'regular'   => esc_html__( 'Normal 400', 'business-class' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'business-class' ),
			'500'       => esc_html__( 'Medium 500', 'business-class' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'business-class' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'business-class' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'business-class' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'business-class' ),
			'700'       => esc_html__( 'Bold 700', 'business-class' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'business-class' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'business-class' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'business-class' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'business-class' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'business-class' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'business-class' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'business-class' ),
		);
	}
