 ...
 * Output overrides.
 */
class Business_Class_Customizer_Output_Property_Font_Family extends Business_Class_Customizer_Output_Property {
	...
	protected function process_value() {
		$google_fonts_array = Business_Class_Customizer_Fonts::get_google_fonts();
