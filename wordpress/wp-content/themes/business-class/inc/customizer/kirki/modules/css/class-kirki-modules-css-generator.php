 ...
 * Handles CSS output.
 */
final class Business_Class_Customizer_Modules_CSS_Generator {
	...
	private function __construct() {
		if ( is_null( self::$google_fonts ) ) {
			self::$google_fonts = Business_Class_Customizer_Fonts::get_google_fonts();
		}
	}
	...
	public static function css( $field ) {
		...
		self::$value = Business_Class_Customizer_Values::get_sanitized_field_value( $field );

		// Find the class that will handle the outpout for this field.
		$classname            = 'Business_Class_Customizer_Output';
		$default_classnames   = array(
			'kirki-background' => 'Business_Class_Customizer_Output_Field_Background',
			'kirki-dimensions' => 'Business_Class_Customizer_Output_Field_Dimensions',
			'kirki-image'      => 'Business_Class_Customizer_Output_Field_Image',
			'kirki-typography' => 'Business_Class_Customizer_Output_Field_Typography',
			'kirki-multicolor' => 'Business_Class_Customizer_Output_Field_Multicolor',
		);
