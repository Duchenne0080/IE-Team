 ...
 */
class Business_Class_Customizer_Modules_Tooltips {
	...
	public function customize_controls_print_footer_scripts() {
		...
		wp_enqueue_script( 'kirki-tooltip', trailingslashit( Business_Class_Customizer::$url ) . 'modules/tooltips/tooltip.js', array( 'jquery' ), BUSINESS_CLASS_CUSTOMIZER_VERSION, false );
		wp_localize_script( 'kirki-tooltip', 'kirkiTooltips', $this->tooltips_content );
		wp_enqueue_style( 'kirki-tooltip', trailingslashit( Business_Class_Customizer::$url ) . 'modules/tooltips/tooltip.css', array(), BUSINESS_CLASS_CUSTOMIZER_VERSION );
	}
}
