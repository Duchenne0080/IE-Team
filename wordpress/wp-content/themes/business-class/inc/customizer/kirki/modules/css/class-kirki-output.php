 ...
 */
class Business_Class_Customizer_Output {
	...
	protected function apply_pattern_replace( $output, $value ) {
		if ( isset( $output['pattern_replace'] ) && is_array( $output['pattern_replace'] ) ) {
			$option_type = ( '' !== Business_Class_Customizer::get_config_param( $this->config_id, 'option_type' ) ) ? Business_Class_Customizer::get_config_param( $this->config_id, 'option_type' ) : 'theme_mod';
			$option_name = Business_Class_Customizer::get_config_param( $this->config_id, 'option_name' );
			$options     = array();
			if ( $option_name ) {
			...
			foreach ( $output['pattern_replace'] as $search => $replace ) {
				...
				switch ( $option_type ) {
					...
					default:
						...
						if ( ! $replacement ) {
							$replacement = Business_Class_Customizer_Values::get_value( $this->field['kirki_config'], $replace );
						}
				}
	...
	protected function process_property_value( $property, $value ) {
		$properties = apply_filters(
			...
			array(
				'font-family'         => 'Business_Class_Customizer_Output_Property_Font_Family',
				'background-image'    => 'Business_Class_Customizer_Output_Property_Background_Image',
				'background-position' => 'Business_Class_Customizer_Output_Property_Background_Position',
			)
		);
