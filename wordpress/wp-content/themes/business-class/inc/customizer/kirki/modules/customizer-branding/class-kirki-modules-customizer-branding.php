 ...
 */
class Business_Class_Customizer_Modules_Customizer_Branding {
	...
	public function customize_controls_print_scripts() {
		...
		if ( ! empty( $vars['logoImage'] ) || ! empty( $vars['description'] ) ) {
			wp_register_script( 'kirki-branding', Business_Class_Customizer::$url . '/modules/customizer-branding/branding.js', array(), BUSINESS_CLASS_CUSTOMIZER_VERSION, false );
