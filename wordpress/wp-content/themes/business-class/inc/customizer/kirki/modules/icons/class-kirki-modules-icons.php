 ...
 */
class Business_Class_Customizer_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		$sections = Business_Class_Customizer::$sections;
		$panels   = Business_Class_Customizer::$panels;
		...
		wp_enqueue_script( 'kirki_panel_and_section_icons', trailingslashit( Business_Class_Customizer::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), BUSINESS_CLASS_CUSTOMIZER_VERSION, true );
