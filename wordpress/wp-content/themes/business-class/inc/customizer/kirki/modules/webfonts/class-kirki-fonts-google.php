 ...
 */
final class Business_Class_Customizer_Fonts_Google {

	/**
	 * The Business_Class_Customizer_Fonts_Google instance.
	...
	private function __construct() {
		...
		$this->google_fonts = Business_Class_Customizer_Fonts::get_google_fonts();
	}
	 ...
	 *
	 * @return object Business_Class_Customizer_Fonts_Google
	 */
	public static function get_instance() {
		if ( null === self::$instance ) {
			self::$instance = new Business_Class_Customizer_Fonts_Google();
		}
	...
	public function generate_google_font( $args ) {
		...
		if ( isset( $args['type'] ) && 'kirki-typography' === $args['type'] ) {
			...
			// Get the value.
			$value = Business_Class_Customizer_Values::get_sanitized_field_value( $args );
			...
			if ( ! isset( $value['font-family'] ) || ! Business_Class_Customizer_Fonts::is_google_font( $value['font-family'] ) ) {
				return;
			}
	...
	public function get_standardfonts_json() {
		echo wp_json_encode( Business_Class_Customizer_Fonts::get_standard_fonts() );
		wp_die();
	}
}
