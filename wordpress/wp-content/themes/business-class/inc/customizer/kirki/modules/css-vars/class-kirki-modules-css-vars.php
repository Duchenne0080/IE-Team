...
/**
 * The Business_Class_Customizer_Modules_CSS_Vars object.
 *
 * @since 3.0.28
 */
class Business_Class_Customizer_Modules_CSS_Vars {
	...
	public function populate_vars() {
		...
		foreach ( $fields as $id => $args ) {
			...
			$val = Business_Class_Customizer_Values::get_value( $args['kirki_config'], $id );
	...
	public function postmessage() {
		wp_enqueue_script( 'kirki_auto_css_vars', trailingslashit( Business_Class_Customizer::$url ) . 'modules/css-vars/script.js', array( 'jquery', 'customize-preview' ), BUSINESS_CLASS_CUSTOMIZER_VERSION, true );
		$fields = Business_Class_Customizer::$fields;
		$data   = array();
