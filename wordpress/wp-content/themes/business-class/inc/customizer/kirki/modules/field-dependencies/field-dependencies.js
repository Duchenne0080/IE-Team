var kirkiDependencies = {
	...
	init: function() {
		...
		wp.customize.control.each( function( control ) {
			self.showTravelTalkCustomizerControl( control );
		} );
				...
				wp.customize( master, function( setting ) {
					var setupControl = function( control ) {
						...
						isDisplayed = function() {
							return self.showTravelTalkCustomizerControl( wp.customize.control( slave ) );
						};
	 ...
	 * @returns {bool}
	 */
	showTravelTalkCustomizerControl: function( control ) {
		var self     = this,
			show     = true,
			isOption = (
	 ...
	 * Check a condition.
	 *
	 * @param {Object} requirement - The requirement, inherited from showTravelTalkCustomizerControl.
