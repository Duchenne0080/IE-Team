 ...
 * @since 3.0.35
 */
class Business_Class_Customizer_Modules_Gutenberg {
	...
	private function set_configs() {
		$this->configs = Business_Class_Customizer::$config;
		return $this->configs;
	}
	...
	private function set_modules_css() {
		$this->modules_css = Business_Class_Customizer_Modules_CSS::get_instance();
	}
	...
	private function set_google_fonts() {
		$this->google_fonts = Business_Class_Customizer_Fonts_Google::get_instance();
	}
	...
	private function set_modules_webfonts() {
		$this->modules_webfonts = Business_Class_Customizer_Modules_Webfonts::get_instance();
	}
}
