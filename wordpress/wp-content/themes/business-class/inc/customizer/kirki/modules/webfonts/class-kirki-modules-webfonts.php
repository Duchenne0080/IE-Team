 ...
 */
class Business_Class_Customizer_Modules_Webfonts {
	...
	/**
	 * The Business_Class_Customizer_Fonts_Google object.
	 *
	 * @access protected
	 * @since 3.0.0
	 * @var object
	 ...
	 */
	public function run() {
		$this->fonts_google = Business_Class_Customizer_Fonts_Google::get_instance();
		$this->init();
	}
	...
	protected function init() {
		foreach ( array_keys( Business_Class_Customizer::$config ) as $config_id ) {
			if ( 'async' === $this->get_method() ) {
				new Business_Class_Customizer_Modules_Webfonts_Async( $config_id, $this, $this->fonts_google );
			}
			new Business_Class_Customizer_Modules_Webfonts_Embed( $config_id, $this, $this->fonts_google );
		}
	}
