...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'business-class' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'business-class' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'business-class' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'business-class' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'business-class' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'business-class' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'business-class' ); ?>',
} );
#>
