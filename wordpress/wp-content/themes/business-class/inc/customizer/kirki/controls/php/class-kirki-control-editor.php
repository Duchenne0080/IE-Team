 ...
 * A TinyMCE control.
 */
class Business_Class_Customizer_Control_Editor extends Business_Class_Customizer_Control_Base {
	 ...
	 *
	 * The actual editor is added from the Business_Class_Customizer_Field_Editor class.
