 ...
 */
class Business_Class_Customizer_Control_Slider extends Business_Class_Customizer_Control_Base {
	...
	protected function content_template() {
		...
		<label>
			...
			<div class="wrapper">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span class="screen-reader-text"><?php esc_html_e( 'Reset', 'business-class' ); ?></span></span>
				<span class="value">
