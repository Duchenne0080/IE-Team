 ...
 */
class Business_Class_Customizer_Control_Color_Palette extends Business_Class_Customizer_Control_Base {
	...
	public function to_json() {
		...
		if ( ! isset( $this->json['choices']['colors'] ) || empty( $this->json['choices']['colors'] ) ) {
			$this->json['choices']['colors'] = Business_Class_Customizer_Helper::get_material_design_colors( 'primary' );
		}
