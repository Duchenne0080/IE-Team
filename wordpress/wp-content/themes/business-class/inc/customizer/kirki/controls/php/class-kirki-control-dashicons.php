 ...
 */
class Business_Class_Customizer_Control_Dashicons extends Business_Class_Customizer_Control_Base {
	...
	public function to_json() {
		parent::to_json();
		$this->json['icons'] = Business_Class_Customizer_Helper::get_dashicons();
	}
